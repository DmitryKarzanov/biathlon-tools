...
{
  "tech": [
    {"key": "Соревнование", "value": "..."},
    {"key": "Место проведения", "value": "..."},
...
Правила:
- Поля place, start_num, year, l1, l2, l3, sum — числа.
- Время (clean_time, time, lost) — строка с запятой как разделителем: "18:37,2".
- Если поле отсутствует — оставь пустую строку "" (или 0 для чисел промахов).
- Поле note — это организация спортсмена, если встречается в строке.
